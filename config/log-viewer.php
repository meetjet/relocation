...
return [
    ...
    */
    ...
    'access_allowed_email' => array_filter(
        explode(',', env('LOG_VIEWER_ACCESS_ALLOWED_EMAIL', '')),
        "trim"
    ),

    'download_allowed_email' => array_filter(
        explode(',', env('LOG_VIEWER_DOWNLOAD_ALLOWED_EMAIL', '')),
        "trim"
    ),

    'delete_allowed_email' => array_filter(
        explode(',', env('LOG_VIEWER_DELETE_ALLOWED_EMAIL', '')),
        "trim"
    ),
];
