 ...
 */
class LithuaniaAddListingConversation extends InlineMenu
{
    ...
    {
        $bot->sendMessage(__('telegram.lithuania.listing-add.start'), [
    ...
    {
        $menu = $this->menuText(__('telegram.lithuania.listing-add.ask-location'));

        collect(Locations::asSelectArray('lithuania'))->each(function ($_value, $_key) use ($menu) {
    ...
    public function handleWrongLocation(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-location-error'));
        $this->askLocation($bot);
    }
    ...
    public function handleLocation(Nutgram $bot): void
    {
        ...
        $this->clearButtons()->closeMenu(__('telegram.lithuania.listing-add.ask-location-chosen', [
            'location' => Locations::getDescription("lithuania", $this->location),
        ]));
    ...
    public function askCategory(Nutgram $bot): void
    {
        ...
        if ($categoryList->count()) {
            $menu = $this->menuText(__('telegram.lithuania.listing-add.ask-category'));
    ...
    {
        $this->clearButtons()->closeMenu();
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-category-error'));
        $this->askCategory($bot);
    }
    ...
    public function handleCategory(Nutgram $bot): void
    {
        ...
        $this->clearButtons()->closeMenu(__('telegram.lithuania.listing-add.ask-category-chosen', [
    ...
    {
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-title'));
    ...
    public function handleTitle(Nutgram $bot): void
    {
        ...
        // Error title type.
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-title-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askTitle($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-description'));
    ...
    public function handleDescription(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-description-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askDescription($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-price'));
    ...
    public function handlePrice(Nutgram $bot): void
    {
        ...
        // Error price type.
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-price-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askPrice($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-picture'));
    ...
    public function handlePicture(Nutgram $bot): void
    {
        ...
        if ($message && $message->getType() === MessageTypes::DOCUMENT) {
            ...
            // Wrong MIME type.
            $bot->sendMessage(__('telegram.lithuania.listing-add.ask-picture-mime-error', [
        ...
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-picture-type-error'));
    }
    ...
    public function askMorePicture(Nutgram $bot): void
    {
        ...
        $this->menuText(__('telegram.lithuania.listing-add.ask-picture-more'))
            ->addButtonRow(
    ...
    public function handlePictureMore(Nutgram $bot): void
    {
        if ($bot->isCallbackQuery()) {
            ...
            if ($isPictureMore) {
                $this->clearButtons()->closeMenu(__('telegram.lithuania.listing-add.ask-picture'));
                $this->next("handlePicture");
            } else {
                $this->clearButtons()->closeMenu();
                $this->askContact($bot);
    ...
    public function askContact(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-contact'));
    ...
    public function handleContact(Nutgram $bot): void
    {
        ...
        if ($message && $message->getType() === MessageTypes::TEXT) {
            ...
            $phoneNumber = parsePhoneNumber($contactValue, "lithuania");
            ...
            // Error contact value.
            $bot->sendMessage(__('telegram.lithuania.listing-add.ask-contact-error-value'), [
                'parse_mode' => ParseMode::HTML,
            ]);
            $this->askContact($bot);
            return;
        ...
        $bot->sendMessage(__('telegram.lithuania.listing-add.ask-contact-error-format'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askContact($bot);
    }
    ...
    public function announcementPreview(Nutgram $bot): void
    {
        ...
        if ($this->customContactType === "email") {
            ...
            $contact = formatPhoneNumber($this->customContactValue, "lithuania");
        } else {
            $contact = "@{$bot->user()->username}";
        }

        $message = $bot->sendMessage(__('telegram.lithuania.listing-add.announcement-preview', [
            'location' => Locations::getDescription("lithuania", $this->location),
        ...
        // Ask confirmation.
        $this->menuText(__('telegram.lithuania.listing-add.ask-confirmation'))
            ->addButtonRow(
    ...
    public function handleConfirmation(Nutgram $bot): void
    {
        ...
        if ($isConfirmed) {
            ListingItem::forceCreate([
                ...
                'price' => $this->price,
                'currency' => config('countries.lithuania.currency.code'),
            ...
            $this->clearButtons()->closeMenu(__('telegram.lithuania.listing-add.confirmation-successful', [
                'link' => addSubdomainToUrl(route('listings.index'), "lithuania"),
            ]));
        } else {
            $this->clearButtons()->closeMenu(__('telegram.lithuania.listing-add.confirmation-canceled'));
        }
    ...
    {
        return __('telegram.lithuania.listing-add.description');
    }
}
