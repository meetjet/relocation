 ...
 */
class TurkeyAddListingConversation extends InlineMenu
{
    ...
    {
        $bot->sendMessage(__('telegram.turkey.listing-add.start'), [
    ...
    {
        $menu = $this->menuText(__('telegram.turkey.listing-add.ask-location'));

        collect(Locations::asSelectArray('turkey'))->each(function ($_value, $_key) use ($menu) {
    ...
    public function handleWrongLocation(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-location-error'));
        $this->askLocation($bot);
    }
    ...
    public function handleLocation(Nutgram $bot): void
    {
        ...
        $this->clearButtons()->closeMenu(__('telegram.turkey.listing-add.ask-location-chosen', [
            'location' => Locations::getDescription("turkey", $this->location),
        ]));
    ...
    public function askCategory(Nutgram $bot): void
    {
        ...
        if ($categoryList->count()) {
            $menu = $this->menuText(__('telegram.turkey.listing-add.ask-category'));
    ...
    {
        $this->clearButtons()->closeMenu();
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-category-error'));
        $this->askCategory($bot);
    }
    ...
    public function handleCategory(Nutgram $bot): void
    {
        ...
        $this->clearButtons()->closeMenu(__('telegram.turkey.listing-add.ask-category-chosen', [
    ...
    {
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-title'));
    ...
    public function handleTitle(Nutgram $bot): void
    {
        ...
        // Error title type.
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-title-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askTitle($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-description'));
    ...
    public function handleDescription(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-description-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askDescription($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-price'));
    ...
    public function handlePrice(Nutgram $bot): void
    {
        ...
        // Error price type.
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-price-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askPrice($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-picture'));
    ...
    public function handlePicture(Nutgram $bot): void
    {
        ...
        if ($message && $message->getType() === MessageTypes::DOCUMENT) {
            ...
            // Wrong MIME type.
            $bot->sendMessage(__('telegram.turkey.listing-add.ask-picture-mime-error', [
        ...
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-picture-type-error'));
    }
    ...
    public function askMorePicture(Nutgram $bot): void
    {
        ...
        $this->menuText(__('telegram.turkey.listing-add.ask-picture-more'))
            ->addButtonRow(
    ...
    public function handlePictureMore(Nutgram $bot): void
    {
        if ($bot->isCallbackQuery()) {
            ...
            if ($isPictureMore) {
                $this->clearButtons()->closeMenu(__('telegram.turkey.listing-add.ask-picture'));
                $this->next("handlePicture");
            } else {
                $this->clearButtons()->closeMenu();
                $this->askContact($bot);
    ...
    public function askContact(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-contact'));
    ...
    public function handleContact(Nutgram $bot): void
    {
        ...
        if ($message && $message->getType() === MessageTypes::TEXT) {
            ...
            $phoneNumber = parsePhoneNumber($contactValue, "turkey");
            ...
            // Error contact value.
            $bot->sendMessage(__('telegram.turkey.listing-add.ask-contact-error-value'), [
                'parse_mode' => ParseMode::HTML,
            ]);
            $this->askContact($bot);
            return;
        ...
        $bot->sendMessage(__('telegram.turkey.listing-add.ask-contact-error-format'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askContact($bot);
    }
    ...
    public function announcementPreview(Nutgram $bot): void
    {
        ...
        if ($this->customContactType === "email") {
            ...
            $contact = formatPhoneNumber($this->customContactValue, "turkey");
        } else {
            $contact = "@{$bot->user()->username}";
        }

        $message = $bot->sendMessage(__('telegram.turkey.listing-add.announcement-preview', [
            'location' => Locations::getDescription("turkey", $this->location),
        ...
        // Ask confirmation.
        $this->menuText(__('telegram.turkey.listing-add.ask-confirmation'))
            ->addButtonRow(
    ...
    public function handleConfirmation(Nutgram $bot): void
    {
        ...
        if ($isConfirmed) {
            ...
            $this->clearButtons()->closeMenu(__('telegram.turkey.listing-add.confirmation-successful', [
                'link' => addSubdomainToUrl(route('listings.index'), "turkey"),
            ]));
        } else {
            $this->clearButtons()->closeMenu(__('telegram.turkey.listing-add.confirmation-canceled'));
        }
    ...
    {
        return __('telegram.turkey.listing-add.description');
    }
}
