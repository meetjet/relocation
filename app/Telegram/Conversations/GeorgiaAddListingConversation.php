...
class GeorgiaAddListingConversation extends InlineMenu
{
    ...
    public function handleLocation(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.georgia.listing-add.ask-location-chosen', [
    ...
    public function handleCategory(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.georgia.listing-add.ask-category-chosen', [
    ...
    public function handlePictureMore(Nutgram $bot): void
    {
        if ($bot->isCallbackQuery()) {
            ...
            if ($isPictureMore) {
                $this->clearButtons()
                    ->closeMenu(__('telegram.georgia.listing-add.ask-picture'));
                $this->next("handlePicture");
            } else {
                $this->clearButtons()
                    ->closeMenu();
