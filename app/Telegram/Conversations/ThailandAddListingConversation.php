 ...
 */
class ThailandAddListingConversation extends InlineMenu
{
    ...
    public function askCategory(Nutgram $bot): void
    {
        ...
        if ($categoryList->count()) {
            $menu = $this->menuText(__('telegram.thailand.listing-add.ask-category'));
    ...
    {
        $this->clearButtons()->closeMenu();
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-category-error'));
        $this->askCategory($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-title'));
    ...
    public function handleTitle(Nutgram $bot): void
    {
        ...
        // Error title type.
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-title-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askTitle($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-description'));
    ...
    public function handleDescription(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-description-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askDescription($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-price'));
    ...
    public function handlePrice(Nutgram $bot): void
    {
        ...
        // Error price type.
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-price-error'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askPrice($bot);
    }
    ...
    {
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-picture'));
    ...
    public function handlePicture(Nutgram $bot): void
    {
        ...
        if ($message && $message->getType() === MessageTypes::DOCUMENT) {
            ...
            // Wrong MIME type.
            $bot->sendMessage(__('telegram.thailand.listing-add.ask-picture-mime-error', [
        ...
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-picture-type-error'));
    }
    ...
    public function askMorePicture(Nutgram $bot): void
    {
        ...
        $this->menuText(__('telegram.thailand.listing-add.ask-picture-more'))
            ->addButtonRow(
    ...
    public function askContact(Nutgram $bot): void
    {
        ...
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-contact'));
    ...
    public function handleContact(Nutgram $bot): void
    {
        ...
        if ($message && $message->getType() === MessageTypes::TEXT) {
            ...
            $phoneNumber = parsePhoneNumber($contactValue, "thailand");
            ...
            // Error contact value.
            $bot->sendMessage(__('telegram.thailand.listing-add.ask-contact-error-value'), [
                'parse_mode' => ParseMode::HTML,
            ]);
            $this->askContact($bot);
            return;
        ...
        $bot->sendMessage(__('telegram.thailand.listing-add.ask-contact-error-format'), [
            'parse_mode' => ParseMode::HTML,
        ]);
        $this->askContact($bot);
    }
    ...
    public function announcementPreview(Nutgram $bot): void
    {
        ...
        if ($this->customContactType === "email") {
            ...
            $contact = formatPhoneNumber($this->customContactValue, "thailand");
        } else {
        ...
        // Ask confirmation.
        $this->menuText(__('telegram.thailand.listing-add.ask-confirmation'))
            ->addButtonRow(
    ...
    {
        return __('telegram.thailand.listing-add.description');
    }
}
