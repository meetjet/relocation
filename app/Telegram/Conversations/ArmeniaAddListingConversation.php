...
class ArmeniaAddListingConversation extends InlineMenu
{
    ...
    public function handleLocation(Nutgram $bot): void
    {
        ...
        $this->clearButtons()->closeMenu(__('telegram.armenia.listing-add.ask-location-chosen', [
    ...
    public function handleCategory(Nutgram $bot): void
    {
        ...
        $this->clearButtons()->closeMenu(__('telegram.armenia.listing-add.ask-category-chosen', [
    ...
    public function handlePictureMore(Nutgram $bot): void
    {
        if ($bot->isCallbackQuery()) {
            ...
            if ($isPictureMore) {
                $this->clearButtons()->closeMenu(__('telegram.armenia.listing-add.ask-picture'));
                $this->next("handlePicture");
            } else {
                $this->clearButtons()->closeMenu();
                $this->askContact($bot);
    ...
    public function handleConfirmation(Nutgram $bot): void
    {
        ...
        if ($isConfirmed) {
            ...
            $this->clearButtons()->closeMenu(__('telegram.armenia.listing-add.confirmation-successful', [
                'link' => addSubdomainToUrl(route('listings.index'), "armenia"),
            ]));
        } else {
            $this->clearButtons()->closeMenu(__('telegram.armenia.listing-add.confirmation-canceled'));
        }
