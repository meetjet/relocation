<div id="single-faq">
    <article id="single-faq-content" class="mb-8 pb-8 border-b border-dashed border-[#a1a5b7]">
        <div class="mb-3">
            <h1 class="text-xl font-bold mb-4">{{ $faq->id }} - {{ $faq->title }}</h1>
        </div>

        <div class="mb-4">{!! $faq->question !!}</div>
